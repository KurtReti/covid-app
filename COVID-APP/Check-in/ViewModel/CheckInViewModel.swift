...
class CheckInVeiwModel: ObservableObject
{
    ...
    @Published var busSignLocation: BusinessSign
    ...
    init() {
        ...
        busSignLocation = BusinessSign(id: "", businessID: "", address: "", qr: "")
        ...
        db.collection("businessSign").whereField("qrCode", isEqualTo: url).limit(to: 1).getDocuments() { (querySnapshot, err) in
            if let err = err {
                ...
                for document in querySnapshot!.documents {
                    ...
                    self.busSignLocation = BusinessSign(id: fsBusinessSignID, businessID: fsBusinessID, address: fsLocation, qr: fsQrCode)
